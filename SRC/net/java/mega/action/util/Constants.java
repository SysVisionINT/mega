...
public class Constants {
	public static final String DEFAULT_WRAPPER_CHAIN = "MEGA_ACTION_DEFAULT_WRAPPER_CHAIN";

	public static final String ACTION_CONFIG_PARAMETER = "config";
	...
	public static final String MULTI_CHECK_BOX = "_MLT_CHCK_BX_";
